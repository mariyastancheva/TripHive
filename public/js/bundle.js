...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFyaXlhc3RhbmNoZXZhIiwiYSI6ImNsZ3Y1cXluYTI4emkzam10dXRqNmJidGcifQ.WD-vjHAeYi-t4fVBfMZnDw';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          partialUrl = type === 'password' ? 'updatePassword' : 'updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', _context.t0.response.data.message || 'Something went wrong.');
        case 11:
        case "end":
          return _context.stop();
      }
...
var stripe = Stripe('pk_test_51N1XndLuGue7GVAzOnVcRS5KCWjF4ARCK0PbONsnsY3caGszVB9z6V8JbjJFicHyrbtQTPUf5S6nvoXQgKzAytEM00JfwEtcVC');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var btn, password, newPassword, passwordConfirm;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
